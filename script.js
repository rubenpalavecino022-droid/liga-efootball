...
/* Fondi de Inicio */
/* Manejo del Splash Screen Mejorado */
window.addEventListener("load", function() {
  const splash = document.getElementById("splash-screen");
  
  // 1. Esperamos 2.5 segundos para que el logo se luzca
  setTimeout(() => {
    // 2. Agregamos la clase que activa la animación suave de CSS
    splash.classList.add("fade-out");
    
    // 3. Eliminamos el elemento del DOM tras 800ms (duración de la transición)
    setTimeout(() => {
